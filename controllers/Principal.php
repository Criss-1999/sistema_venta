                    ...
                    if ($data['estado'] == 1) {
                        if (password_verify($clave , $data['clave'] )) {
                            ...
                            if ($acceso > 0 ) {
                                ...
                                $res = array('msg' => 'ERROR AL OBTENER LOS DATOS DEL INICIO', 'type'=> 'error');
                            }
                        }else{
                            $res = array('msg' => 'LA CONTRASEÑA ES INCORRECTA' , 'type'=> 'warning');
                        }
                    } else {
    ...
    public function enviarCorreo($correo)
    {
        ...
        if (!empty($verificar)) {
            ...
            try {
                ...
                //Recipients
                $mail->setFrom('from@example.com', 'Punto Venta');
