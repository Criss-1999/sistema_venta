...
class Proveedor extends Controller
{
    ...
    public function registrar()
    {
        ...
        if (isset($_POST['ruc']) && isset($_POST['nombre'])) {
            if (empty($ruc)) {
                ...
                if ($id == '') {
                    $vereficarRuc = $this->model->getValidar('ruc', $ruc, 'registrar', 0);
                    if (empty($vereficarRuc)) {
                    ...
                    $vereficarRuc = $this->model->getValidar('ruc', $ruc, 'actualizar', $id);
                    if (empty($vereficarRuc)) {
    ...
    public function restaurar($idProveedor)
    {
        ...
        if (isset($_GET) && is_numeric($idProveedor)) {
            ...
            if ($data == 1) {
                $res = array('msg' => 'PROVEEDOR HA SIDO RESTAURADO', 'type' => 'success');
            } else {
