...
class Usuarios extends Controller
{
    ...
    public function registrar()
    {
        ...
        if (isset($_POST)) {
            if (empty($_POST['nombres'])) {
                ...
                $res = array('msg' => 'INGRESE EL APELLIDO', 'type' => 'warning');
                ...
                $res = array('msg' => 'INGRESE LA CONTRASEÑA', 'type' => 'warning');
            } else if (empty($_POST['rol'])) {
                $res = array('msg' => 'INGRESE EL ROL', 'type' => 'warning');
            } else {
                    ...
                    if (empty($verificarCorreo)) {
                        ...
                        if (empty($verificarTelefono)) {
                            ...
                            if ($data > 0) {
                                ...
                                $res = array('msg' => 'ERROR AL REGISTRAR AL USUARIO', 'type' => 'error');
                            }
                        } else {
                            $res = array('msg' => 'EL TELÉFONO DEBE SER UNICO', 'type' => 'warning');
                        }
                    } else {
                    ...
                    if (empty($verificarCorreo)) {
                        ...
                        if (empty($verificarTelefono)) {
                            ...
                            if ($data > 0) {
                                ...
                                $res = array('msg' => 'ERROR AL ACTUALIZAR AL USUARIO', 'type' => 'error');
                            }
                        } else {
                            $res = array('msg' => 'EL TELÉFONO DEBE SER UNICO', 'type' => 'warning');
                        }
        ...
        if (isset($_GET)) {
            if (is_numeric($id)) {
                ...
                if ($data == 1) {
                    ...
                    $res = array('msg' => 'ERROR AL ELIMINAR AL USUARIO', 'type' => 'error');
                }
            } else {
                $res = array('msg' => 'ERROR DESCONOCIDO', 'type' => 'error');
            }
    ...
    public function inactivos()
    {
        ...
        $data['script'] = 'usuario-inactivos.js';
        ...
        if (isset($_GET)) {
            if (is_numeric($id)) {
                ...
                if ($data == 1) {
                    ...
                    $res = array('msg' => 'ERROR AL RESTAURAR AL USUARIO', 'type' => 'error');
                }
            } else {
                $res = array('msg' => 'ERROR DESCONOCIDO', 'type' => 'error');
            }
    ...
    public function modificarDatos()
    {
        ...
        if (empty($nombre)) {
            ...
            $res = array('msg' => 'INGRESE EL CORREO ELECTRONICO', 'type' => 'warning');
