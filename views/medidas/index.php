        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active mt-2" id="nav-medidas" role="tabpanel" aria-labelledby="nav-medidas-tab" tabindex="0">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hove align-middle nowrap" id="tblMedidas" style="width: 100%;">
                        <thead>
                            <tr>
                                <th>Nombre</th>
                                <th>Nombre Corto</th>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" type="text" name="nombre" id="nombre" placeholder="Nombre de la Medida">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" type="text" name="nombre_corto" id="nombre_corto" placeholder="Nombre de la nombre">
                            </div>
