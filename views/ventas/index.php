                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input class="form-control" type="number" id="pagar_con" placeholder="0.00" required>
                        </div>
                        <div id="bltCambio">
                            <label>Cambio:</label>
                            <div class="input-group mb-2">
                                <span class="input-group-text"><i class="fas fa-dollar-sign"></i></span>
                                <input class="form-control" type="number" id="cambio" placeholder="0.00" min="0" readonly>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group mb-2">
                            <span class="input-group-text"><i class="fas fa-dollar-sign"></i></span>
                            <input class="form-control" type="number" id="descuento" placeholder="Descuento">
                        </div>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <select id="metodo" class="form-control" onchange="selectipo(event)">
