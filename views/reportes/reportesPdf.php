        ...
        <tbody>
            ...
            foreach ($data['productos'] as $producto) { ?>
                <tr>
                    ...
                    <td class="text-center"><?php echo number_format($producto['precio_compra'], 2); ?></td>
                    <td class="text-center"><?php echo number_format($producto['precio_venta'], 2); ?></td>
                    <td class="text-center"><?php echo $producto['cantidad']; ?></td>
                    <td class="text-center"><?php echo $producto['ventas']; ?></td>
                </tr>
            <?php } ?>           
        </tbody>
    </table>
