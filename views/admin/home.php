			...
			<div class="card-body">
				<div class="d-flex align-items-center">
					<div>
						...
						<h4 class="my-1 text-danger"><?php echo $data['proveedor']['total']; ?></h4>
						<a class="mb-0 font-13" href="<?php echo BASE_URL . 'proveedor'; ?>">Detalle</a>
					</div>
				...
				<div class="d-flex align-items-center">
					...
					<div class="dropdown ms-auto">
						...
						<ul class="dropdown-menu">
							<li><a class="dropdown-item" href="<?php echo BASE_URL . 'admin/topProductosPdf'; ?>" target="_blank">
									<i class="fas fa-file-pdf text-danger"></i> Reporte PDF</a>
							</li>
							<li><a class="dropdown-item" href="<?php echo BASE_URL . 'admin/topProductosExcel'; ?>">
									<i class="fas fa-file-excel text-success"></i>Reporte Excel</a>
						</ul>
					</div>
				</div>
...
<div class="card radius-10">
	<div class="card-body">
		<div class="d-flex align-items-center">
			<div>
				<h6 class="mb-0">Productos Nuevos</h6>
			</div>
			<div class="dropdown ms-auto">
				<a class="dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown"><i class='bx bx-dots-horizontal-rounded font-22 text-option'></i>
				</a>
				<ul class="dropdown-menu">
					<li><a class="dropdown-item" href="<?php echo BASE_URL . 'admin/recientesPdf'; ?>" target="_blank">
							<i class="fas fa-file-pdf text-danger"></i>Reporte PDF</a>
					</li>
					<li><a class="dropdown-item" href="<?php echo BASE_URL . 'admin/recientesExcel'; ?>">
							<i class="fas fa-file-excel text-success"></i>Reporte Excel</a>
					</li>
				</ul>
			</div>
			...
			<div class="card-header bg-transparent">
				<div class="d-flex align-items-center">
					...
					<div class="dropdown ms-auto">
						...
						<ul class="dropdown-menu">
							<li><a class="dropdown-item" href="<?php echo BASE_URL . 'admin/stockMinimoPdf'; ?>" target="_blank">
									<i class="fas fa-file-pdf text-danger"></i>Reporte PDF</a>
							</li>
							<li><a class="dropdown-item" href="<?php echo BASE_URL . 'admin/stockMinimoExcel'; ?>">
									<i class="fas fa-file-excel text-success"></i>Reporte Excel</a>
							</li>
						</ul>
					</div>
