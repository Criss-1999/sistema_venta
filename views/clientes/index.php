        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active mt-2" id="nav-clientes" role="tabpanel" aria-labelledby="nav-clientes-tab" tabindex="0">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hove align-middle nowrap" id="tblClientes" style="width: 100%;">
                        <thead>
                            <tr>
                                <th>Identidad</th>
                                <th>N° Identidad</th>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" type="number" name="num_identidad" id="num_identidad" maxlength="10" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="Numero de Identidad">
                            </div>
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea id="direccion" class="form-control" name="direccion" rows="3" placeholder="Direccion del Cliente"></textarea>
                            </div>
