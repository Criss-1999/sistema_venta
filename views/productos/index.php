    ...
    <div class="card-body">
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown ms-auto">
                ...
                <li><a class="dropdown-item" href="<?php echo BASE_URL . 'productos/reportePdf'; ?>" target="_blank" ><i class="fas fa-file-pdf text-danger"></i>Reporte PDF</a>
                    ...
                    <li><a class="dropdown-item" href="<?php echo BASE_URL . 'productos/generadBarcode'; ?>" target="_blank"><i class="fas fa-barcode "></i>Barcode</a>
                    </li>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active mt-2" id="nav-productos" role="tabpanel" aria-labelledby="nav-productos-tab" tabindex="0">
                <h5 class="card-title text-center"><i class="fa-solid fa-boxes-packing"></i> Listado de Productos</h5>
                <hr>
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hove align-middle nowrap" id="tblProductos" style="width: 100%;">
                        <thead>
                            <tr>
                                <th>Codigo</th>
                                <th>Descripcion</th>
            ...
            <div class="tab-pane fade-3" id="nav-nuevo" role="tabpanel" aria-labelledby="nav-nuevo-tab" tabindex="0">
                <form id="formulario" autocomplete="off">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" type="text" name="codigo" id="codigo" placeholder="Nombre del Codigo">
                            </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" type="number" step="0.01" min="0.01" name="precio_compra" id="precio_compra" placeholder="Precio de la Compra">
                            </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="fas fa-dollar-sign"></i></span>
                                <input class="form-control" type="number" name="precio_venta" id="precio_venta" placeholder="Precio de la Venta">
                            </div>
                    ...
                    <div class="text-end">
                        <button class="btn btn-danger" type="submit" id="btnNuevo">Nuevo</button>
