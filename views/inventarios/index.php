            ...
            <div class="tab-pane fade show active mt-2" id="nav-inventarios" role="tabpanel" aria-labelledby="nav-inventarios-tab" tabindex="0">
                <div class="alert alert-info border-0 bg-info alert-dismissible fade show py-2">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <h6 class="mb-0 text-white">MOVIMINETOS DE LOS PRODUCTOS</h6>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hove align-middle nowrap" id="tblInventario" style="width: 100%;">
                        <thead>
                            <tr>
                                <th>Producto</th>
                                <th>Movimiento</th>
