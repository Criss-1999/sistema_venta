...
<div class="card">
    <div class="card-body">
        ...
        <div class="d-flex align-items-center">
            <div>
                <h5 class="card-title text-center"><i class="fas fa-box"></i> Historial de Cajas</h5>
            </div>
        ...
        if (!empty($data['caja'])) { ?>
            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <button class="nav-link" id="nav-historial-tab" data-bs-toggle="tab" data-bs-target="#nav-historial" type="button" role="tab" aria-controls="nav-historial" aria-selected="false">Historial de Gastos</button>
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active mt-2" id="nav-apertura" role="tabpanel" aria-labelledby="nav-apertura-tab" tabindex="0">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hove align-middle nowrap" id="tblAperturaCierre" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>Monto Inicial</th>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="number" step="0.01" min="0.01" id="monto" name="monto" placeholder="Ingrese el Monto">
                                </div>
                            </div>
                ...
                <div class="tab-pane fade p-3" id="nav-historial" role="tabpanel" aria-labelledby="nav-historial-tab" tabindex="0">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hove align-middle nowrap" id="tblGastos" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>Monto</th>
                                    <th>Descripcion</th>
