        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active mt-2" id="nav-proveedores" role="tabpanel" aria-labelledby="nav-proveedores-tab" tabindex="0">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hove align-middle nowrap" id="tblProveedores" style="width: 100%;">
                        <thead>
                            <tr>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" type="number" name="ruc" id="ruc"  placeholder="Numero de Ruc">
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" type="number" name="telefono" id="telefono" maxlength="10" placeholder="Ingrese el Telefono">
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" type="text" name="correo" id="correo" placeholder="Ingrese el Correo">
                            </div>
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea id="direccion" class="form-control" name="direccion" rows="3" placeholder="Direccion de Proveedor"></textarea>
                            </div>
