        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active mt-2" id="nav-usuarios" role="tabpanel" aria-labelledby="nav-usuarios-tab" tabindex="0">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hove align-middle nowrap" id="tblUsuarios" style="width: 100%;">
                        <thead>
                            <tr>
                                <th>Nombre</th>
                                <th>Correo</th>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-4  col-sm-6 mb-2">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="number" id="telefono" name="telefono" class="form-control" maxlength="10" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="Ingrese el Teléfono">
                            </div>
                        ...
                        <div class="col-lg-4  col-sm-6 mb-2">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="password" id="clave" name="clave" class="form-control" placeholder="Ingrese la Contraseña">
                            </div>
