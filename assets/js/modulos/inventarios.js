...
document.addEventListener("DOMContentLoaded", function () {
  ...
  btnBuscar.addEventListener("click", function () {
    if (mes.value == "") {
      alertaPersonalizada("warning", "SELECCIONE EL MES");
    } else {
  ...
  btnProcesar.addEventListener("click", function () {
    if (idProductoAjuste.value == "" && buscarNombreAjuste.value == "") {
      alertaPersonalizada("warning", "INGRESE EL PRODUCTO");
    } else if (cantidadAjuste.value == "") {
      alertaPersonalizada("warning", "INGRESE LA CANTIDAD");
    } else {
      ...
      http.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
          ...
          if (res.estado) {
            ...
            errorBusqueda.textContent = " EL CODIGO NO EXISTE";
            //alertaPersonalizada("warning", " EL CODIGO NO EXISTE");
          }
        }
      };
    }
  ...
  http.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      if (res.estado) {
        ...
        errorBusquedaAjuste.textContent = "EL CODIGO NO EXISTE";
        //alertaPersonalizada("warning", " EL CODIGO NO EXISTE");
      }
    }
  };
