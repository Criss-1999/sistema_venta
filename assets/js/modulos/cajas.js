...
document.addEventListener("DOMContentLoaded", function () {
  ...
  btnAbrirCaja.addEventListener("click", function () {
    if (monto_inicial.value == "") {
      alertaPersonalizada("warning", "INGRESE EL MONTO INICIAL");
    } else {
  ...
  if (formulario && document.querySelector("#reporteMovimiento")) {
    ...
    formulario.addEventListener("submit", function (e) {
      ...
      if (monto.value == "") {
        ...
        alertaPersonalizada("warning", "INGRESE LA DESCRIPCION");
      } else {
        const url = base_url + "cajas/registrarGasto";
