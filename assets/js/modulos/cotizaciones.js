...
document.addEventListener('DOMContentLoaded', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.length > 0) {
                        ...
                        errorCliente.textContent = 'EL NOMBRE DEL CLIENTE NO EXISTE';
                    }
                }
            });
        },
    ...
    btnAccion.addEventListener('click', function () {
        ...
        if (filas < 2) {
            ...
            alertaPersonalizada('warning', 'INGRESE EL CLIENTE');
            return;
        } else if (metodo.value == '') {
            alertaPersonalizada('warning', 'INGRESE EL METODO');
            return;
        } else if (validez.value == '') {
            alertaPersonalizada('warning', 'INGRESE LA VALIDEZ');
            return;
        } else {
