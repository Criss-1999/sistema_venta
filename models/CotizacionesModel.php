...
class CotizacionesModel extends Query
{
    ...
    {
        $sql = "SELECT ct.*, cl.identidad, cl.num_identidad, cl.nombre, cl.telefono, cl.direccion FROM cotizaciones ct 
        INNER JOIN clientes cl ON  ct.id_cliente = cl.id WHERE ct.id =$idCotizacion ";
         return $this->select($sql);
    }
